...
| [`social-algorithm`](./skills/social-algorithm/) | Knowledge base for **organic personal-brand acquisition + Instagram algorithm dynamics**. Nine chapters of field-tested practitioner material: indirect selling (4 elements: direct experience, need, hero's journey, social proof as garnish), the epochal algorithm shift (interest-based distribution, dopamine-driven users, -20/24% engagement drop), creator systems & delegation (revenue/hours formula vs content/hours, 3-stage delegation ladder, Inside Out / Reference / Pillar ideation, Reference Based / Author Mode / AI-assisted scripting, full-day blocking), end-to-end acquisition system ("I See You / I Validate You / I Associate You" triangle, 4 Circles of Hell anti-patterns, 5 awareness levels, 6 acquisition funnels including profile / follower outreach / ManyChat / Stories / lead magnet / quiz funnel, ADV integration prospecting + retargeting), dynamic video techniques (visual elements + metaphors, framing changes, custom B-roll, trailer-style scripts), 5 scaling principles, and a working algorithm knowledge base (3 pillar metrics (saves / watch time / shares), diagnostic matrix "lots of X but few Y" with a targeted fix per signal, discovery-first repost strategy, 8 non-inflated hook patterns, era-by-era evolution of platform dynamics), why people act (CTA as a gentle nudge, felt need before action, real reasons people pay + desire-over-pain frames), and the *why-a-personal-brand-now* case (AI favors whoever stays human, the "no time" excuse, immortality/long-term compounding asset, exposure not tech is the real barrier, document-don't-overproduce, making content ≠ having a personal brand). Plus glossary (~60 terms), patterns.md (33 operational techniques), cheatsheet.md (quick-reference tables). | Practitioner field notes + tested operational frameworks | `personal brand`, `indirect selling`, `instagram algorithm`, `organic acquisition`, `client acquisition`, `social algorithm`, `organic funnel`, `saves watch time`, `recognizability`, `hero's journey`, `personal brand positioning`, `i see you i validate you i associate you`, `circles of hell`, `manychat` |
| [`ffmpeg`](./skills/ffmpeg/) | Complete **FFmpeg** command-line reference + toolkit distilled from the official FFmpeg documentation (every component). Front-loaded core mental model (option ordering, 0-based stream specifiers, stream-copy vs transcode, CRF/bitrate/2-pass rate control, simple-vs-complex filtergraph syntax, `-ss` placement). 10 on-demand chapters: cli tools (ffmpeg/ffplay/ffprobe), stream selection & `-map`, options reference, codecs (libx264/265, NVENC/QSV/VAAPI, aac/mp3/opus), formats (mp4/mkv/hls/dash/segment/concat/image2), filters (scale/crop/overlay/concat/drawtext/xfade/amix + hw filters), protocols (file/pipe/http/rtmp/srt/tee), capture devices (gdigrab/dshow/x11grab/v4l2/avfoundation), swscale/swresample, libav* libraries + capability discovery. Ships `cheatsheet.md` (copy-paste commands for the 90% cases), `patterns.md` (17 task recipes with trade-offs), `glossary.md` (~40 terms), and the full official docs bundled at `reference/` (~1.9 MB) for exhaustive grep. | Official FFmpeg documentation (ffmpeg.org, all tools, components & libraries) | `ffmpeg`, `ffprobe`, `transcode`, `remux`, `filtergraph`, `-vf`, `-filter_complex`, `-map`, `scale`, `overlay`, `concat`, `drawtext`, `hls`, `crf`, `nvenc`, `screen capture` |
| [`video-editor`](./skills/video-editor/) | Software-agnostic **decision system for editing viral video** (short + long form), distilled and deduplicated from **25 expert breakdowns** across talking-head, motion-graphics, cinematic/aesthetic, character/avatar animation, hand-drawn overlays, and viral caption animation. North-star principles (retention-not-length, match the audience experience, idea→script→edit, less-is-more, show-don't-tell); structure templates (**HPC** for short, **4-pillar** for long, funnel for conversion); a multi-channel **hook system** (claim taxonomy, open loops, anticipation rope, payoff-placement rule); motion (overshoot+motion-blur+easing+stagger+secondary, eyeline-match, premium-motion formula), text/captions (3-role system, typographic size-hierarchy, fade-in recipe, legibility scrim), sound (motion-sound coupling, riser/hit/drone, music-as-engine), color/composition/finishing, transitions, distribution/platform-fit, **character & hand-drawn animation** (easing→intent, velocity graph, avatar/preset reuse, onion-skin + blend-mode keying); plus a 7-step **intervention-priority** ladder, anti-patterns, and build/review checklists. Pairs with an executor like `/video-use` (this decides WHAT/WHY, the executor does the software HOW). Ships `knowledge-base.md` (full theory by area) + `rules.md` (top-20 rules). | 25 expert YouTube video-editing breakdowns (Premiere / DaVinci / CapCut / After Effects), deduped | `video editing`, `edit my video`, `reel`, `short`, `tiktok`, `retention`, `hook`, `pacing`, `b-roll`, `captions`, `motion graphics`, `keyframes`, `easing`, `sound design`, `color grade`, `transitions`, `viral edit`, `character animation` |
| [`public-speaking-persuasion`](./skills/public-speaking-persuasion/) | Knowledge base on **public speaking and persuasion theory**: structuring a speech or pitch, applying persuasion frameworks, handling objections or a hostile audience, writing persuasively. 14 chapters covering the 3 Pillars of Persuasion (Logos/Ethos/Pathos) and Point X, the 5-Line Story Structure + 3 Ingredients + 6-Senses detail, storytelling for attention (Domino-Tile, But/So connector, 60-second story), a 16-entry logical-fallacy catalog and 18-entry cognitive-bias catalog, delivery mechanics (5 Aspects of Voice, 4-Step Method, 3-Minute Daily Practice), speech openings (Three Openings, One-Sentence Rule, Image-Over-Text), audience diagnosis (4 Types, Reopen-the-Decision technique, Conversation Aikido for objections), anxiety management (4 Ways of Dealing with Anxiety, 3 Power Tools), persuasive writing ("This"-opening, Write/Edit Separation), pitching (7 Elements of a Pitch, 4 Levels of Question), calls to action (Direct vs. Indirect close, Institutional Yes), and leadership communication. Plus glossary, patterns.md, and a bias/fallacy/audience/opening/close cheatsheet. | 51 theoretical transcripts on communication and persuasion technique | `public speaking`, `persuasion`, `pitch`, `storytelling structure`, `logical fallacy`, `cognitive bias`, `objection handling`, `hostile audience`, `speech opening`, `call to action`, `sales pitch` |
| [`marketing-mba`](./skills/marketing-mba/) | MBA-level **marketing and startup execution** knowledge base. 9 chapters: marketing fundamentals (4Ps, AIDA, mission/vision/values, BCG Matrix, product life cycle, diffusion of innovation, NPD process), segmentation/positioning/branding (segmentation criteria, perceptual maps, points of parity/difference, brand architecture, Minimum Viable Segment), pricing/distribution/promotion (skimming vs. penetration vs. prestige, break-even, distribution intensity, IMC, CPM, media scheduling), strategy vs. planning (Porter's Five Forces, SWOT, the "planning trap"), value proposition & business model design (the Four U's — Unworkable/Unavoidable/Urgent/Underserved, the BLAC needs matrix, the Three D's, CORE, Multipliers vs. Levers), startup execution/team/fundraising (founder-readiness tests, "the Ungame," hiring frameworks, MAT, fundraising-stage ladder), sales/negotiation/persuasion (B2B pipeline, the 4 Pillars, principled negotiation/BATNA, the 10/20/30 pitch rule, CENTER), consumer psychology/leadership/effectiveness (the Compromise Effect, the P/M/O framework, Netflix's culture playbook, the 10X Rule, matching-market design), and inbound marketing/social growth/product marketing (the inbound loop, SEO/content tactics, social-media growth, product marketing & PM career frameworks, customer success ops). Plus glossary (~50 terms), patterns.md (13 playbooks), cheatsheet.md. | 90 theoretical marketing/startup/business transcripts | `marketing`, `value proposition`, `segmentation`, `pricing strategy`, `go-to-market`, `business model`, `pitch deck`, `b2b sales`, `negotiation`, `startup strategy`, `porter five forces`, `inbound marketing`, `seo` |
