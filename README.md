...
| [`social-algorithm`](./skills/social-algorithm/) | Italian-language knowledge base for **personal brand organic acquisition + Instagram algorithm dynamics**. Seven chapters of field-tested practitioner material: vendita indiretta (4 elements — esperienza, bisogno, cammino dell'eroe, social proof prezzemolo), the epochal algorithm shift (interest-based distribution, dopaminic users, -20/24% engagement drop), creator systems & delegation (revenue/hours formula vs content/hours, 3-stage delegation ladder, Inside Out / Reference / Pillar ideation, Reference Based / Author Mode / AI-assisted scripting, full-day blocking), end-to-end acquisition system ("Ti Vedo / Ti Valido / Ti Associo" triangle, 4 Gironi anti-patterns, 5 awareness levels, 6 acquisition funnels including profile/contact-follower/ManyChat/stories/lead magnet/quiz funnel, ADV integration prospecting+retargeting), dynamic video techniques (visual elements + metaphors, framing changes, custom b-roll, trailer-style scripts), 5 scaling principles, and a working algorithm knowledge base (3 pillar metrics — saves/watch time/shares — diagnostic matrix "molti X ma pochi Y" with fix per signal, discovery-first repost strategy, 8 non-inflated hook patterns, era-by-era evolution of platform dynamics). Plus glossary (~60 terms), patterns.md (33 operational techniques), cheatsheet.md (quick-reference tables). | Practitioner field notes + tested operational frameworks | `personal brand`, `vendita indiretta`, `algoritmo instagram`, `organico`, `acquisizione clienti`, `social algorithm`, `funnel organico`, `salvataggi watch time`, `riconoscibilità`, `cammino dell'eroe`, `posizionamento personal brand`, `ti vedo ti valido ti associo`, `gironi infernali`, `manychat` |
