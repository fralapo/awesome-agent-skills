...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/skills-8-2ea44f?style=for-the-badge" alt="Skills count">
...
Pick one. Replace `<skill>` with the skill name (`seedance-prompts`, `image-gen-prompts`, `awesome-readme`, `llm-wiki`, `social-algorithm`, `creative-director`, `ffmpeg`, or `video-editor`).
