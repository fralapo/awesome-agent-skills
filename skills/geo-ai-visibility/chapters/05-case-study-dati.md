...
- Uno studio aggregato su **680M+ citazioni** (6 grandi studi, ago 2024–apr 2026) mostra che il **top 1% dei domini (~12 siti)** — Wikipedia, Reddit, Forbes, Healthline, Investopedia, NYT, grandi domini .gov/.edu — cattura il **47%** di tutte le citazioni AI. (fonte: research/07-case-study-dati.md)
- L'overlap tra motori è bassissimo: solo l'**11%** dei domini è citato sia da ChatGPT sia da Perplexity. (fonte: research/07-case-study-dati.md)
