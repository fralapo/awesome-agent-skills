# Chapter 4: Tooling e Misurazione dell'AI Visibility

## Core Idea
Nel 2025-2026 è nata una categoria di tool dedicata a misurare la "AI visibility" dei brand — presenza, share of voice e sentiment nelle risposte di ChatGPT, Perplexity, Gemini, Copilot e Google AI Overviews — analoga ai rank tracker della SEO classica ma costruita da zero per un output che non è più una lista di link. È una categoria affollata, in rapida crescita di finanziamenti, e ancora priva di uno standard di misurazione consolidato.
...
- **Budget basso / iniziare a monitorare**: Otterly.AI. (fonte: research/06-tooling-misurazione.md)
...
2. Profound è il player più finanziato ($96M Series C, valutazione $1B a feb 2026, $155M di funding totale) e posizionato enterprise; Peec AI è una startup europea in rapida crescita (€650K ARR in 4 mesi, poi €18M Series A a nov 2025) forte su share-of-voice analytics (fonte: research/06-tooling-misurazione.md).
3. Otterly.AI ha l'entry point più basso della categoria (piani da $29/mese), mentre AthenaHQ si distingue per la demo di visibilità AI in tempo reale durante le sales call (fonte: research/06-tooling-misurazione.md).
4. Le suite SEO storiche (Semrush, Ahrefs) stanno integrando moduli AI-visibility come add-on (AI toolkit, Brand Radar) invece di lasciare la categoria solo a startup dedicate (fonte: research/06-tooling-misurazione.md).
5. I dati di questi tool sono stime da campionamento, non un censimento reale — e dato che solo l'11% dei domini è citato sia da ChatGPT sia da Perplexity, serve tracking multi-piattaforma, non un singolo motore (fonte: research/06-tooling-misurazione.md).

## Fonti
- https://www.trustsignals.com/blog/the-top-12-tools-for-measuring-ai-visibility-and-brand-mentions-in-llms-2026
- https://www.tryprofound.com/blog/best-ai-visibility-tools-for-marketing-agencies
- https://llmpulse.ai/blog/best-ai-visibility-tools/
- https://www.surmado.com/blog/best-ai-visibility-tools-2026
- https://seocounselors.com/resources/best-ai-visibility-platform
- https://industry-lens.com/intelligence/ai-search
